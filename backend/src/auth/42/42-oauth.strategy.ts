...
export class OAuth42Strategy extends PassportStrategy(Strategy, '42') {
    constructor(
        ...
        super({
            ...
            authorizationURL: 'https://api.intra.42.fr/oauth/authorize?client_id=ed0b86fd834fae7e8171d1f8dc0a84ef3586cec062339193fe00184dbf7fa685&redirect_uri=https%3A%2F%2Flocalhost%3A3000%2Fauth%2F42%2Fredirect&response_type=code',
            ...
            callbackURL: "https://localhost:3000/auth/42/redirect",
            scope: 'public',
            proxy: true,
        })
    }
